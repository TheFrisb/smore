        ...
        <div class="flex items-center space-x-4">
            <div class="bg-secondary-500/10 p-3 rounded-lg">
                <svg class="w-5 h-5 text-white">
                    <use xlink:href="/static/assets/svg/sprite15.svg#${ticket.product.name.toLowerCase()}Icon"></use>
                </svg>
            </div>
            <div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="w-8 h-8 rounded-full flex items-center justify-center ">
                        <svg class="w-6 h-6 betStatusIcon ${bet_line.status == "WON" ? "text-green-500" : "text-red-500"}">
                            <use xlink:href="/static/assets/svg/sprite15.svg#${bet_line.status.toLowerCase()}BetIcon"></use>
                        </svg>
                    </div>
                </div>
     ...
     ${prediction.status == "LOST" ? "bg-red-500/10 border-red-500/50 hover:border-red-500" : "bg-[#14212e] border-emerald-500/50 hover:border-emerald-500"}
        ...
        <div class="mb-6">
            ...
            <div class="flex  justify-center items-center space-x-3 text-primary-300">
                <div class="bg-primary-900/80 p-2 rounded-lg">
                    <svg class="w-5 h-5 text-white"><use xlink:href="/static/assets/svg/sprite15.svg#${prediction.match.type.toLowerCase()}Icon"></use></svg>
                </div>
        ...
        <div class="mb-6">
            <div class="flex items-center justify-center mb-2">
                ${prediction.status == "LOST" ? '<div class="flex items-center justify-end gap-2"><p class="text-red-500 font-bold">LOST</p><svg class="w-5 h-5 text-red-500"><use xlink:href="/static/assets/svg/sprite15.svg#circleX"></use></svg> </div>' : '<div class="flex items-center justify-end gap-2"><p class="text-emerald-500 font-bold">WON</p><svg class="w-5 h-5 text-emerald-500"><use xlink:href="/static/assets/svg/sprite15.svg#circleCheck"></use></svg></div>'}
            </div>
