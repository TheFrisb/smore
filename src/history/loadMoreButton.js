        ...
        <div class="flex items-center space-x-4">
            <div class="bg-secondary-500/10 p-3 rounded-lg">
                <svg class="w-5 h-5 text-white">
                    <use xlink:href="/static/assets/svg/sprite16.svg#${ticket.product.name.toLowerCase()}Icon"></use>
                </svg>
            </div>
            <div>
                ...
                <div class="relative z-10">
                    ...
                    <div class="w-8 h-8 rounded-full flex items-center justify-center ">
                        <svg class="w-6 h-6 betStatusIcon ${bet_line.status == "WON" ? "text-green-500" : "text-red-500"}">
                            <use xlink:href="/static/assets/svg/sprite16.svg#${bet_line.status.toLowerCase()}BetIcon"></use>
                        </svg>
                    </div>
                </div>
