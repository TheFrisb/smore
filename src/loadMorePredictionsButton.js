  ...
  button.addEventListener("click", function () {
        ...
        <div class="flex items-center justify-center w-full">
            <div class="flex  justify-center items-center space-x-3 text-primary-300">
                <div class="bg-primary-900/80 p-2 rounded-lg">
                    <svg class="w-5 h-5 text-white"><use xlink:href="/static/assets/svg/sprite14.svg#${prediction.match.type.toLowerCase()}Icon"></use></svg>
                </div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-center mb-2">
            ${prediction.status == "LOST" ? '<div class="flex items-center justify-end gap-2"><p class="text-red-500 font-bold">LOST</p> <svg class="w-5 h-5 text-red-500"><use xlink:href="/static/assets/svg/sprite14.svg#circleX"></use></svg></div>' : '                <div class="flex items-center justify-end gap-2"><p class="text-emerald-500 font-bold">WON</p><svg class="w-5 h-5 text-emerald-500"><use xlink:href="/static/assets/svg/sprite14.svg#circleCheck"></use></svg></div>'}
