    ...
    def handle(self, *args, **kwargs):
        ...
        with open(output_file, 'w') as f:
            ...
            while processed < total:
                ...
                league_teams = SportLeagueTeam.objects.select_related(
                    'league', 'team'
                ).only(
                    'season',
                    'league__external_id',
                ...
                self.stdout.write(f'Processed {processed}/{total} league-team relationships...')
                first = False

            f.write(']')  # End of JSON array

        self.stdout.write(self.style.SUCCESS(f'Exported {total} league-team relationships to {output_file}'))
