...
from core.models import SportLeague, SportLeagueTeam, SportTeam
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for i, rel in enumerate(relationships_data, 1):
            try:
                ...
                relationships_to_create.append(
                    SportLeagueTeam(
                        league_id=league_id, team_id=team_id, season=rel["season"]
                    )
                )
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Finished importing {total} league-team relationships")
        )
