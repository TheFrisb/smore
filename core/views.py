...
class PlansView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["user_has_soccer"] = self._get_user_has_soccer(context["subscriptions"])

        context["page_title"] = _("Plans")

        return context

    def _get_user_has_soccer(self, products: list[Product]):
        ...
        soccer_product = next(
            (product for product in products if product.name == Product.Names.SOCCER),
            None,
        )
