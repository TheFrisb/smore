...
class MessageSenderProcessor(BaseProcessor):
    def __init__(self):
        super().__init__(name="MessageSenderProcessor", llm_model="o3-mini-2025-01-31")
    ...
    def _get_system_message(self, prompt_type: PromptType):
        if (
                ...
                or prompt_type in self.get_multi_match_related_prompt_types()
        ):
        ...
        if prompt_type in self.get_single_match_related_prompt_types():
