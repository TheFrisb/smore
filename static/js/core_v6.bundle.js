/*! For license information please see core_v6.bundle.js.LICENSE.txt */
(() => {
  var a = {
      629: (a, t, o) => {
        "use strict";
        ...
        a.exports = function (a, t, o) {
          ...
          function _() {
            ...
            if (((e = arguments), (s = this), (r = a), o)) {
              if (void 0 === d)
                return (function (a) {
                  return (l = a), (d = setTimeout(w, t)), c ? v(a) : i;
                })(r);
          ...
          return (
            ...
            f(o) &&
              ((c = !!o.leading),
              (n = (u = "maxWait" in o) ? y(b(o.maxWait) || 0, t) : n),
          ...
          return (
            ...
            (function (a, t, o) {
              ...
              function L() {
                var a = f(),
                  o = w(a);
                if (((s = arguments), (n = this), (l = a), o)) {
                  if (void 0 === r)
                    return (function (a) {
                      return (c = a), (r = setTimeout(x, t)), u ? g(a) : d;
                    })(l);
                  if (y) return (r = setTimeout(x, t)), g(l);
                }
      ...
      72: (a) => {
        ...
        a.exports = function (a, s) {
          ...
          return function (a) {
            ...
            for (var r = e(a, s), l = 0; l < n.length; l++) {
              var c = o(n[l]);
    ...
    (() => {
      ...
      function O(a) {
        ...
        for (t = 0; t < a.length; t += 1) {
          ...
          if (((e = o.children && O(o.children)), e)) return !0;
        }
        return !1;
      }
      ...
      const W = new (class {
        ...
        $ = (a, t, o) => {
          const e = window.innerHeight,
            s = X(a, "anchor"),
            n = X(a, "anchor-placement"),
            i = Number(X(a, "offset", n ? 0 : t)),
            d = n || o;
          let r = a;
          s &&
          ...
          switch (d) {
            ...
            case "top-center":
              ...
              break;
            case "center-center":
              l += e / 2 + r.offsetHeight / 2;
              break;
            case "bottom-center":
              l += e / 2 + r.offsetHeight;
              break;
            case "top-top":
              l += e;
              break;
            ...
            (a.prototype._buildNotificationCard = function (a) {
              ...
              if (e) {
                ...
                if (
                  ...
                  f && (b.style.color = f), l.appendChild(b);
                }
                i.appendChild(l);
              }
              if (
      ...
      function ma() {
        ...
        function E(a, t) {
          function o(s, n, i, d) {
            ...
            if ("throw" !== r.type) {
              var l = r.arg,
                c = l.value;
              return c && "object" == ya(c) && e.call(c, "__await")
        ...
        function S(t, o, e) {
          ...
          return function (n, i) {
            ...
            for (e.method = n, e.arg = i; ; ) {
              ...
              var l = u(t, o, e);
              if ("normal" === l.type) {
                if (((s = e.done ? f : m), l.arg === b)) continue;
                return { value: l.arg, done: e.done };
              }
              "throw" === l.type &&
                ((s = f), (e.method = "throw"), (e.arg = l.arg));
            }
          };
        }
        ...
        function j(t, o) {
          ...
          if ("throw" === n.type)
            return (
              (o.method = "throw"), (o.arg = n.arg), (o.delegate = null), b
            );
          var i = n.arg;
          return i
            ? i.done
        ...
        return (
          ...
          (v.displayName = l(g, r, "GeneratorFunction")),
          ...
          (t.mark = function (a) {
            return (
              Object.setPrototypeOf
                ...
                : ((a.__proto__ = g), l(a, r, "GeneratorFunction")),
              (a.prototype = Object.create(L)),
              a
            );
          }),
          (t.awrap = function (a) {
          ...
          k(E.prototype),
          l(E.prototype, d, function () {
            return this;
          }),
          (t.AsyncIterator = E),
          (t.async = function (a, o, e, s, n) {
            void 0 === n && (n = Promise);
            var i = new E(c(a, o, e, s), n);
          ...
          (C.prototype = {
            ...
            delegateYield: function (t, o, e) {
              return (
                (this.delegate = { iterator: O(t), resultName: o, nextLoc: e }),
                        ...
                        "BANK" === fa
                          ...
                          : "PAYONEER" === fa
                            ? {
                                ...
                                email: document.querySelector(
                                  "#requestWithdrawal__payoneerMethod__email",
                                ).value,
                              }
                            : "CRYPTOCURRENCY" === fa
                              ? {
                        ...
                        '\n                              <div class="bg-primary-800/50 backdrop-blur-sm rounded-lg p-6 border border-primary-700/30 hover:border-emerald-500/20 transition-all duration-300 group transform transition-all duration-300 animate-fadeIn">\n                        <div class="flex items-center justify-between mb-6">\n                            <div class="flex  justify-start items-center space-x-3 text-primary-300">\n                                <div class="bg-primary-900/50 p-2 rounded-lg">\n\n\n                                    <svg class="w-4 h-4 text-white"><use xlink:href="/static/assets/svg/sprite10.svg#soccerIcon"></use></svg>\n\n                                </div>\n\n                                <span class="text-sm text-primary-100">Soccer</span>\n\n                            </div>\n                            <div class="flex items-center space-x-2 px-4 py-2 rounded-lg\n                                    '
                          ...
                          .concat(
                            ...
                            (o =
                              ...
                              (function (a, t) {
                                if (a) {
                                  if ("string" == typeof a) return La(a, t);
